...
shaka.Player.prototype.load = async function(
  ...
  try {
    ...
    // HACK: This updated function doesn't always drop variants if codec
...
shaka.Player.prototype.chooseCodecsAndFilterManifest_ = function() {
  ...
  // HACK: If the browser supports codec switching, don't filter out any codecs.
  if (shaka.media.MediaSourceEngine.isCodecSwitchingSupported()) {
    return;
  }
