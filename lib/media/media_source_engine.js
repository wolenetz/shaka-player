 ...
 * @return {boolean}
 */
shaka.media.MediaSourceEngine.isCodecSwitchingSupported = function() {
 ...
 * @return {!Promise}
 */
shaka.media.MediaSourceEngine.prototype.changeType =
    function(contentType, newFullMimeType) {
  return this.enqueueOperation_(
      contentType,
 ...
 * @private
 */
shaka.media.MediaSourceEngine.prototype.change_ =
    function(contentType, newFullMimeType) {
