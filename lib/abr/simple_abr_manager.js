...
shaka.abr.SimpleAbrManager.prototype.chooseVariant = function() {
  ...
  // HACK: Randomly pick amongst any of the variants with maxBandwidth >=
  // currentBandwidth. This is to more frequently demonstrate variant
  // adaptations, and with multicodec manifests on browsers that support codec
  // switching, also demonstrate codec switching more frequently.
  let maxI = 0;
  ...
  let chosen = sortedVariants[Math.floor(Math.random() * (maxI + 1))] || null;
